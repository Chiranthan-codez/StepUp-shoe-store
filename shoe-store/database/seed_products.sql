...
(106, 'Trail Running Pro', 'Merrell', 189.00, NULL, 'Outdoor', 4.8, 142, TRUE, 'https://s7d4.scene7.com/is/image/WolverineWorldWide/MRLW-J035494-062220-F20-000?wid=900&hei=900') ON CONFLICT (id) DO NOTHING;
...
(202, 'Elegant Heel', 'Jimmy Choo', 599.00, NULL, 'Women', 4.8, 167, FALSE, 'https://th.bing.com/th/id/OIP.n5ZZpVdvcLztfDvPRkk1oAHaHa?w=216&h=216&c=7&r=0&o=5&dpr=1.3&pid=1.7') ON CONFLICT (id) DO NOTHING;
...
(802, 'Forum Low', 'Adidas', 139.00, NULL, 'Lifestyle', 4.4, 234, FALSE, 'https://tse3.mm.bing.net/th/id/OIP.lg1-4flYY5b77SlpRAjWvQHaHa?pid=ImgDet&w=184&h=184&c=7&dpr=1.3&o=7&rm=3') ON CONFLICT (id) DO NOTHING;
...
(1009, 'Dunk Low Premium', 'Nike', 139.00, NULL, 'Lifestyle', 4.8, 567, TRUE, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=400&h=400&fit=crop&crop=center') ON CONFLICT (id) DO NOTHING;
...
(2009, 'Solar Glide 5', 'Adidas', 149.00, NULL, 'Running', 4.6, 345, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
...
(3009, 'AMG casual shoes', 'Puma', 189.00, NULL, 'Training', 4.7, 156, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
...
(4008, 'Run Star Hike', 'Converse', 129.00, 149.00, 'Lifestyle', 4.3, 267, TRUE, NULL) ON CONFLICT (id) DO NOTHING;
...
(5002, 'Classic Leather RB', 'Reebok', 119.00, 139.00, 'Lifestyle', 4.6, 198, FALSE, 'https://tse3.mm.bing.net/th/id/OIP.ipvtKnkF-fZ9z-LRKck0VAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3') ON CONFLICT (id) DO NOTHING;
...
(6006, 'Training Flex6X', 'New Balance', 149.00, NULL, 'Training', 4.6, 198, TRUE, NULL) ON CONFLICT (id) DO NOTHING;
...
(7006, 'Old Skool V6', 'Vans', 99.00, NULL, 'Casual', 4.7, 342, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
...
(8006, 'HIIT Trainer V6', 'Under Armour', 169.00, NULL, 'Training', 4.5, 189, FALSE, NULL) ON CONFLICT (id) DO NOTHING;
...
(9003, 'Gel-Nimbus 24 V3', 'ASICS', 189.00, 219.00, 'Running', 4.9, 198, TRUE, NULL) ON CONFLICT (id) DO NOTHING;
