...
const lifestyleShoes = [
  {
    ...
    previewImages: [
      "https://images.unsplash.com/photo-1463100099107-aa0980c362e6?w=600&h=600&fit=crop&crop=center",
  ...
  },
  {
    ...
    previewImages: [
      "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/e3ac8de8-8a06-44be-a623-2288d542ec23/custom-dunk-high-unlocked-by-you.png",
      "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=600&h=600&fit=crop&crop=center",
...
export default function Lifestyle({
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/30 dark:to-indigo-900/30 py-8 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold">Lifestyle Shoes</h1>
          </div>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl font-sans">
            Express your unique style with our fashion-forward lifestyle
            collection. Premium designs for modern living.
          </p>
        </div>
      </div>
